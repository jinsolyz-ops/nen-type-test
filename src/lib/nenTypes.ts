...
export const nenTypes: NenType[] = [
  ...
  },
  {
    ...
    desc: "사람이든 물체든 조종하는 계통이에요. 싸움에서 이기는 게 목적이 아니라 처음부터 지지 않는 판을 만드는 스타일입니다. 이르미를 보면 알잖아요. 처음부터 이길 수 없는 게임을 설계해놓고 상대를 불러들이죠. 샤르나크도 마찬가지입니다. 조작계는 싸우기 전에 이미 이긴 상태를 만드는 계통이에요.",
    ability: "생물/무생물 조종, 원격 제어, 명령 부여 및 자동화",
    personality: '냉정하고 계획적입니다. 감정에 흔들리지 않아요. 항상 주도권을 쥐려 하고 예측 못한 상황을 제일 싫어하죠. 주변에서 "저 사람 무섭다"는 소리를 들을 수 있는데 본인은 그게 칭찬인 줄 압니다. 근데 실제로 칭찬 맞아요.',
    mbti: ["ENTJ", "ENTP", "INTJ"],
    characters: [
      {
        name: "이르미 조르딕",
  ...
  },
  {
    ...
    desc: "6개 계통 어디에도 안 들어가는 특수한 능력이에요. 극소수만 발현되고 능력 형태도 전부 달라서 설명 자체가 불가능합니다. 크로로의 스킬 헌터, 크라피카의 엠퍼러 타임. 이 계통은 그 사람의 존재 자체가 특별한 케이스예요. 근데 그게 꼭 좋은 의미가 아닐 수도 있습니다. 크라피카를 보세요. 특질계가 발현된 이유가 뭔지.",
    ability: "기존 6계통으로 분류 불가, 고유하고 독자적인 능력, 규칙 자체를 초월",
    personality: '카리스마 있고 압도적인 존재감이 있어요. 무리를 이끌거나 아니면 완전히 혼자이거나 둘 중 하나입니다. 평범한 삶이랑은 거리가 멀고 본인도 그걸 알고 있죠. 짊어진 게 남들보다 많은 타입이에요. "왜 저 사람은 저렇게 태어났을까" 소리 듣는 유형입니다.',
    mbti: ["INFJ", "INTJ", "ENFJ"],
    characters: [
      {
        name: "클로로 루실후르",
